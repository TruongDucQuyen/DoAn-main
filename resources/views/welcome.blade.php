...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="/template/assets/images/favicon-32x32.png">
                                                ...
                                                <ul class="mega-menu-style mega-menu-mrg-1">
                                                    <li>
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="shop.html"><img src="/template/assets/images/banner/banner-12.png" alt=""></a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                    ...
                    <div class="row align-items-center">
                        <div class="col-5">
                            <div class="mobile-logo">
                                <a href="index.html">
                                    <img alt="" src="/template/assets/images/logo/logo.png">
                                </a>
                            </div>
                        </div>
                        <div class="col-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="hero-slider-img-1 slider-animated-1">
                                    <img class="animated" src="/template/assets/images/slider/hm-1-slider-1.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3">
                            <div class="about-us-logo">
                                <img src="/template/assets/images/about/logo.png" alt="logo">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="single-product-wrap mb-35">
                                    <div class="product-img product-img-zoom mb-20">
                                        <a href="product-details.html">
                                            <img src="/template/assets/images/product/product-2.jpg" alt="">
                                        </a>
                                        <div class="product-action-wrap">
                                            <div class="product-action-left">
                                                <button><i class="icon-basket-loaded"></i>Add to Cart</button>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="single-product-wrap mb-35">
                                    <div class="product-img product-img-zoom mb-20">
                                        <a href="product-details.html">
                                            <img src="/template/assets/images/product/product-4.jpg" alt="">
                                        </a>
                                        <div class="product-action-wrap">
                                            <div class="product-action-left">
                                                <button><i class="icon-basket-loaded"></i>Add to Cart</button>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="single-product-wrap mb-35">
                                    <div class="product-img product-img-zoom mb-20">
                                        <a href="product-details.html">
                                            <img src="/template/assets/images/product/product-5.jpg" alt="">
                                        </a>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="single-product-wrap mb-35">
                                    <div class="product-img product-img-zoom mb-20">
                                        <a href="product-details.html">
                                            <img src="/template/assets/images/product/product-7.jpg" alt="">
                                        </a>
                                        <div class="product-action-wrap">
                                            <div class="product-action-left">
                                                <button><i class="icon-basket-loaded"></i>Add to Cart</button>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="single-product-wrap mb-35">
                                    <div class="product-img product-img-zoom mb-20">
                                        <a href="product-details.html">
                                            <img src="/template/assets/images/product/product-8.jpg" alt="">
                                        </a>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="single-product-wrap mb-35">
                                    <div class="product-img product-img-zoom mb-20">
                                        <a href="product-details.html">
                                            <img class="default-img" src="/template/assets/images/product/product-4.jpg" alt="">
                                        </a>
                                        <div class="product-action-wrap">
                                            <div class="product-action-left">
                                                <button><i class="icon-basket-loaded"></i>Add to Cart</button>
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-7">
                        <div class="banner-wrap banner-mr-1 mb-30">
                            <div class="banner-img banner-img-zoom">
                                <a href="product-details.html"><img src="/template/assets/images/banner/banner-1.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-5 col-md-5">
                        <div class="banner-wrap  banner-ml-1 mb-30">
                            <div class="banner-img banner-img-zoom">
                                <a href="product-details.html"><img src="/template/assets/images/banner/banner-2.jpg" alt=""></a>
                            </div>
            ...
            <div class="container">
                <div class="brand-logo-wrap brand-logo-mrg">
                    <div class="single-brand-logo mb-10">
                        <img src="/template/assets/images/brand-logo/brand-logo-1.png" alt="brand-logo">
                    </div>
                    <div class="single-brand-logo mb-10">
                        <img src="/template/assets/images/brand-logo/brand-logo-2.png" alt="brand-logo">
                    </div>
                    <div class="single-brand-logo mb-10">
                        <img src="/template/assets/images/brand-logo/brand-logo-3.png" alt="brand-logo">
                    </div>
                    <div class="single-brand-logo mb-10">
                        <img src="/template/assets/images/brand-logo/brand-logo-4.png" alt="brand-logo">
                    </div>
                    <div class="single-brand-logo mb-10">
                        <img src="/template/assets/images/brand-logo/brand-logo-5.png" alt="brand-logo">
                    </div>
                </div>
            </div>
        </div>
